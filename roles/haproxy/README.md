...
| --------------------------------- | --------------------------------------------------------------- | -------------------------------------------------------------- |
| `haproxy_configuration_file_path` | Path where the configuration file will be stored in the host[1] | `/etc/haproxy/haproxy.cfg`                                     |
...
| `haproxy_container_image`         | Container image name, including registry                        | Unset                                                          |
| `haproxy_container_tag`           | Container image tag                                             | Unset                                                          |
